...
const AddBook = (Props: any) => {
    ...
    // useEffect(() => {
    //     // bookManager.addBooks(book, dispatch);
    // })
    ...
    const handleBookInput = () => {
        ...
        bookManager.addBooks(dispatch, book, token)
    }
        ...
        <>
            <form>
                <div className="group">
                    ...
                    <button type="button" className="btn btn-primary btn1" onClick={() => { handleBookInput(); history.push("/") }}>Submit</button>
